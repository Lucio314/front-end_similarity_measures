...
/**
 * @param {boolean} RFTHIsSelected
 * @returns 
 */
function ParametreRFTH({RFTHIsSelected}){

    useEffect(() =>{
        const idDivParamRFTH = document.getElementById('id-param-rfth')
        if(RFTHIsSelected){
            idDivParamRFTH.hidden = false
        }else{
            idDivParamRFTH.hidden = true
        }
    }, [])
