...
import MethodtHeadCell from './MethodTHeadCell';
import MethodTBodyRow from './MethodTBodyRow';
...
function MethodsTable({}){
    ...
    for(let THeadCellule of THEADCELLS){
        listeTHeadCellules.push(
            <MethodtHeadCell upperText={THeadCellule.upperText} lowerText={THeadCellule.lowerText}/>
        )
    }
    ...
    for(let TBodyCellule of TBODYROWS){
        listeTBodyRows.push(
            <MethodTBodyRow
                ...
                methodName={TBodyCellule.methodName}
                support={TBodyCellule.sup}
                flexibilite={TBodyCellule.flex}
                longueur={TBodyCellule.long}
                ontologie={TBodyCellule.onto}
                vitesse={TBodyCellule.vit}
            />
        )
    }
